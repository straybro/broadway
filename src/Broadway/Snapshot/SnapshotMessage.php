...
final class SnapshotMessage
{
    ...
    {
        return new SnapshotMessage($id, $playhead, $metadata, $payload, DateTime::now());
    }
    ...
    public function andMetadata(Metadata $metadata)
    {
        ...
        return new SnapshotMessage($this->id, $this->playhead, $newMetadata, $this->payload, $this->recordedOn);
    }
}
